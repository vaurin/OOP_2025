...
def draw_person(surface, x, y):
    ...
    for angle in range(210, 330, 10):
        x1 = x + 75 * math.cos(math.radians(angle))
        y1 = y - 70 + 75 * math.sin(math.radians(angle))
        x2 = x + 60 * math.cos(math.radians(angle + 5))
        y2 = y - 70 + 60 * math.sin(math.radians(angle + 5))
        x3 = x + 60 * math.cos(math.radians(angle - 5))
        y3 = y - 70 + 60 * math.sin(math.radians(angle - 5))
...
# Табличка
polygon(screen, (0, 0, 0), [(250, 130), (250, 165), (650, 165), (650, 130)], 5)  # обводка таблички
polygon(screen, (0, 255, 0), [(250, 130), (250, 165), (650, 165), (650, 130)])  # табличка
